...
export default function UnityDeveloperUkPage() {
  const breadcrumbItems = [
    ...
    { name: "Unity Developer UK", path: "/unity-developer-uk" },
  ];
  ...
  return (
    <main>
      <div className="mx-auto w-full max-w-7xl px-6 pt-10 lg:px-8">
        <SchemaScript
          id="unity-developer-uk-schema"
          value={[
            buildServiceSchema({
              name: "Unity Developer UK",
              path: "/unity-developer-uk",
              description:
                "Freelance Unity development in the UK for gameplay systems, prototypes, cross-platform builds, and structured technical delivery.",
      ...
      <section className="mx-auto w-full max-w-7xl px-6 py-20 lg:px-8">
        <div className="rounded-md border border-amber-500/30 bg-[color:var(--color-accent-soft)] p-8 lg:p-10">
          ...
          <p className="mt-4 max-w-4xl text-base leading-8 text-stone-300">
            ...
            to playable product, let&apos;s discuss your project and next steps.
          </p>
          <p className="mt-4 max-w-4xl text-base leading-8 text-stone-300">
